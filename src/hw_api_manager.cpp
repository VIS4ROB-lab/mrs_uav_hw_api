...
class HwApiManager : public mrs_lib::Node {
 ...
 private:
  ...
  std::unique_ptr<pluginlib::ClassLoader<mrs_uav_hw_api::MrsUavHwApi>>
      plugin_loader_;
  ...
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiControlGroupCmd>
      sh_control_group_cmd_;
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAttitudeRateCmd>
      sh_attitude_rate_cmd_;
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAttitudeCmd> sh_attitude_cmd_;
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAccelerationHdgRateCmd>
      sh_acceleration_hdg_rate_cmd_;
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAccelerationHdgCmd>
      sh_acceleration_hdg_cmd_;
  mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiVelocityHdgRateCmd>
  ...
  mrs_lib::PublisherHandler<sensor_msgs::msg::MagneticField>
      ph_mag_magnetic_field_;
  ...
  mrs_lib::PublisherHandler<geometry_msgs::msg::QuaternionStamped>
      ph_orientation_;
  mrs_lib::PublisherHandler<geometry_msgs::msg::Vector3Stamped>
      ph_angular_velocity_;
...
HwApiManager::HwApiManager(rclcpp::NodeOptions options)
    : mrs_lib::Node("hw_api_manager", options) {
  this->initialize();
}
...
void HwApiManager::initialize() {
  ...
  if (_version_ != VERSION) {
    RCLCPP_ERROR(node_->get_logger(),
                 "the version of the binary (%s) does not match the config "
                 "file (%s), please build me!",
                 VERSION, _version_.c_str());
    rclcpp::shutdown();
  }
  ...
  param_loader_->loadParam("publish_rate/distance_sensor",
                           _pub_distance_sensor_rate_);
  ...
  param_loader_->loadParam("publish_rate/mag_magnetic_field",
                           _pub_mag_magnetic_field_rate_);
  param_loader_->loadParam("publish_rate/rc_channels", _pub_rc_channels_rate_);
  param_loader_->loadParam("publish_rate/battery_state",
                           _pub_battery_state_rate_);
  ...
  param_loader_->loadParam("publish_rate/angular_velocity",
                           _pub_angular_velocity_rate_);
  param_loader_->loadParam("publish_rate/odometry", _pub_odometry_rate_);
  param_loader_->loadParam("publish_rate/ground_truth",
                           _pub_ground_truth_rate_);
  ...
  sh_actuator_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiActuatorCmd>(
          shopts, "~/actuator_cmd", &HwApiManager::callbackActuatorCmd, this);

  sh_control_group_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiControlGroupCmd>(
          shopts, "~/control_group_cmd", &HwApiManager::callbackControlGroupCmd,
          this);

  sh_attitude_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAttitudeCmd>(
          shopts, "~/attitude_cmd", &HwApiManager::callbackAttitudeCmd, this);

  sh_attitude_rate_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAttitudeRateCmd>(
          shopts, "~/attitude_rate_cmd", &HwApiManager::callbackAttitudeRateCmd,
          this);

  sh_acceleration_hdg_rate_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAccelerationHdgRateCmd>(
          shopts, "~/acceleration_hdg_rate_cmd",
          &HwApiManager::callbackAccelerationHdgRateCmd, this);

  sh_acceleration_hdg_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiAccelerationHdgCmd>(
          shopts, "~/acceleration_hdg_cmd",
          &HwApiManager::callbackAccelerationHdgCmd, this);

  sh_velocity_hdg_rate_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiVelocityHdgRateCmd>(
          shopts, "~/velocity_hdg_rate_cmd",
          &HwApiManager::callbackVelocityHdgRateCmd, this);

  sh_velocity_hdg_cmd_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::HwApiVelocityHdgCmd>(
          shopts, "~/velocity_hdg_cmd", &HwApiManager::callbackVelocityHdgCmd,
          this);
...

  {
    ...
    ph_capabilities_ =
        mrs_lib::PublisherHandler<mrs_msgs::msg::HwApiCapabilities>(
            opts, "~/capabilities");
  }

  {
    ...
    ph_status_ =
        mrs_lib::PublisherHandler<mrs_msgs::msg::HwApiStatus>(opts, "~/status");
  }

  {
    ...
    ph_connected_ =
        mrs_lib::PublisherHandler<std_msgs::msg::Empty>(opts, "~/connected");
  }

  {
    ...
    ph_gnss_ =
        mrs_lib::PublisherHandler<sensor_msgs::msg::NavSatFix>(opts, "~/gnss");
  }

  {
    ...
    ph_gnss_status_ = mrs_lib::PublisherHandler<mrs_msgs::msg::GpsInfo>(
        opts, "~/gnss_status");
  }
...

  {
    ...
    ph_distance_sensor_ = mrs_lib::PublisherHandler<sensor_msgs::msg::Range>(
        opts, "~/distance_sensor");
  }

  {
    ...
    ph_mag_heading_ = mrs_lib::PublisherHandler<mrs_msgs::msg::Float64Stamped>(
        opts, "~/mag_heading");
  }
...

  {
    ...
    ph_altitude_ = mrs_lib::PublisherHandler<mrs_msgs::msg::HwApiAltitude>(
        opts, "~/altitude");
  }
...

  {
    ...
    ph_rc_channels_ = mrs_lib::PublisherHandler<mrs_msgs::msg::HwApiRcChannels>(
        opts, "~/rc_channels");
  }

  {
    ...
    ph_battery_state_ =
        mrs_lib::PublisherHandler<sensor_msgs::msg::BatteryState>(
            opts, "~/battery_state");
  }

  {
    ...
    ph_position_ = mrs_lib::PublisherHandler<geometry_msgs::msg::PointStamped>(
        opts, "~/position");
  }
...

  {
    ...
    ph_odometry_ =
        mrs_lib::PublisherHandler<nav_msgs::msg::Odometry>(opts, "~/odometry");
  }

  {
    ...
    ph_ground_truth_ = mrs_lib::PublisherHandler<nav_msgs::msg::Odometry>(
        opts, "~/ground_truth");
  }
  ...
  ss_arming_ = mrs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
      node_, "~/arming",
      std::bind(&HwApiManager::callbackArming, this, std::placeholders::_1,
                std::placeholders::_2),
      cbkgrp_ss_);
...

  {
    std::function<void()> callback_fcn =
        std::bind(&HwApiManager::timerStatus, this);

    timer_diagnostics_ = std::make_shared<TimerType>(
        opts, rclcpp::Rate(_timer_diagnostics_rate_), callback_fcn);
  }

  {
    std::function<void()> callback_fcn =
        std::bind(&HwApiManager::timerMode, this);

    timer_mode_ = std::make_shared<TimerType>(
        opts, rclcpp::Rate(_timer_mode_rate_), callback_fcn);
  }
  ...
  common_handlers_->getBodyFrameName =
      std::bind(&HwApiManager::getBodyFrameName, this);
  common_handlers_->getWorldFrameName =
      std::bind(&HwApiManager::getWorldFrameName, this);

  common_handlers_->publishers.publishGNSS =
      std::bind(&HwApiManager::publishGNSS, this, std::placeholders::_1);
  common_handlers_->publishers.publishGNSSStatus =
      std::bind(&HwApiManager::publishGNSSStatus, this, std::placeholders::_1);
  common_handlers_->publishers.publishRTK =
      std::bind(&HwApiManager::publishRTK, this, std::placeholders::_1);
  common_handlers_->publishers.publishDistanceSensor = std::bind(
      &HwApiManager::publishDistanceSensor, this, std::placeholders::_1);
  common_handlers_->publishers.publishAltitude =
      std::bind(&HwApiManager::publishAltitude, this, std::placeholders::_1);
  common_handlers_->publishers.publishIMU =
      std::bind(&HwApiManager::publishIMU, this, std::placeholders::_1);
  common_handlers_->publishers.publishMagnetometerHeading = std::bind(
      &HwApiManager::publishMagnetometerHeading, this, std::placeholders::_1);
  common_handlers_->publishers.publishMagneticField = std::bind(
      &HwApiManager::publishMagneticField, this, std::placeholders::_1);
  common_handlers_->publishers.publishStatus =
      std::bind(&HwApiManager::publishStatus, this, std::placeholders::_1);
  common_handlers_->publishers.publishRcChannels =
      std::bind(&HwApiManager::publishRcChannels, this, std::placeholders::_1);
  common_handlers_->publishers.publishBatteryState = std::bind(
      &HwApiManager::publishBatteryState, this, std::placeholders::_1);

  common_handlers_->publishers.publishPosition =
      std::bind(&HwApiManager::publishPosition, this, std::placeholders::_1);
  common_handlers_->publishers.publishOrientation =
      std::bind(&HwApiManager::publishOrientation, this, std::placeholders::_1);
  common_handlers_->publishers.publishVelocity =
      std::bind(&HwApiManager::publishVelocity, this, std::placeholders::_1);
  common_handlers_->publishers.publishAngularVelocity = std::bind(
      &HwApiManager::publishAngularVelocity, this, std::placeholders::_1);
  common_handlers_->publishers.publishOdometry =
      std::bind(&HwApiManager::publishOdometry, this, std::placeholders::_1);
  common_handlers_->publishers.publishGroundTruth =
      std::bind(&HwApiManager::publishGroundTruth, this, std::placeholders::_1);

  // | -------------------- load the plugin -------------------- |

  plugin_loader_ =
      std::make_unique<pluginlib::ClassLoader<mrs_uav_hw_api::MrsUavHwApi>>(
          "mrs_uav_hw_api", "mrs_uav_hw_api::MrsUavHwApi");

  try {
    RCLCPP_INFO(node_->get_logger(), "loading the plugin '%s'",
                _plugin_address_.c_str());
    hw_api_ = plugin_loader_->createSharedInstance(_plugin_address_.c_str());
  } catch (pluginlib::CreateClassException& ex1) {
    RCLCPP_ERROR(node_->get_logger(),
                 "CreateClassException for the plugin '%s'",
                 _plugin_address_.c_str());
    RCLCPP_ERROR(node_->get_logger(), "Error: %s", ex1.what());
    rclcpp::shutdown();
  } catch (pluginlib::PluginlibException& ex) {
    RCLCPP_ERROR(node_->get_logger(), "PluginlibException for the plugin '%s'",
                 _plugin_address_.c_str());
...
void HwApiManager::callbackActuatorCmd(
    const mrs_msgs::msg::HwApiActuatorCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackControlGroupCmd(
    const mrs_msgs::msg::HwApiControlGroupCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackAttitudeRateCmd(
    const mrs_msgs::msg::HwApiAttitudeRateCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackAttitudeCmd(
    const mrs_msgs::msg::HwApiAttitudeCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackAccelerationHdgRateCmd(
    const mrs_msgs::msg::HwApiAccelerationHdgRateCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackAccelerationHdgCmd(
    const mrs_msgs::msg::HwApiAccelerationHdgCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackVelocityHdgRateCmd(
    const mrs_msgs::msg::HwApiVelocityHdgRateCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackVelocityHdgCmd(
    const mrs_msgs::msg::HwApiVelocityHdgCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackPositionCmd(
    const mrs_msgs::msg::HwApiPositionCmd::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::callbackTrackerCmd(
    const mrs_msgs::msg::TrackerCommand::ConstSharedPtr msg) {
  if (!is_initialized_) {
    return;
  }
...
bool HwApiManager::callbackArming(
    const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
    const std::shared_ptr<std_srvs::srv::SetBool::Response> response) {
  if (!is_initialized_) {
    return false;
...
bool HwApiManager::callbackOffboard(
...
std::string HwApiManager::getUavName(void) { return _uav_name_; }

//}

/* getBodyFrameName() //{ */

std::string HwApiManager::getBodyFrameName(void) { return _body_frame_name_; }

//}

/* getBodyFrameName() //{ */

std::string HwApiManager::getWorldFrameName(void) { return _world_frame_name_; }
...
void HwApiManager::publishMagnetometerHeading(
...
void HwApiManager::publishMagneticField(
...
void HwApiManager::publishRcChannels(
...
void HwApiManager::publishPosition(
...
void HwApiManager::publishOrientation(
...
void HwApiManager::publishVelocity(
...
void HwApiManager::publishAngularVelocity(
    const geometry_msgs::msg::Vector3Stamped& msg) {
  if (!is_initialized_) {
    return;
  }
...
void HwApiManager::publishBatteryState(
